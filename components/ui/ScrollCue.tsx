...
export function ScrollCue({ targetId }: { targetId: string }) {
  ...
  return (
    <button
      ...
      className="hero-cue inline-flex h-12 w-12 items-center justify-center rounded-full border border-line bg-ground text-ink shadow-sm transition-colors hover:border-accent hover:text-accent"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
